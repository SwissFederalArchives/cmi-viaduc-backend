...
With the release 2.3.0.1151, the public access application, the internal management application and core application are moved under repository( [cmi-viaduc-backend](https://github.com/SwissFederalArchives/cmi-viaduc-backend/tree/master/CMI/Web.Clients/CMI.Web.Frontend).
