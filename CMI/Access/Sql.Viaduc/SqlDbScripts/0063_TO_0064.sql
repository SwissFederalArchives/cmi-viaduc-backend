-- ** Neue Spalte auf OrderItem ** --
ALTER TABLE OrderItem ADD
	HasAufbereitungsfehler BIT NOT NULL CONSTRAINT DF_OrderItem_HasAufbereitungsfehler DEFAULT 0

EXEC sys.sp_addextendedproperty @level1name=N'OrderItem', @level2name=N'HasAufbereitungsfehler', @value=N'Gibt an, dass bei der Verarbeitung durch den Digipool ein Fehler aufgetreten ist.', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level2type=N'COLUMN', @name=N'MS_Description'
