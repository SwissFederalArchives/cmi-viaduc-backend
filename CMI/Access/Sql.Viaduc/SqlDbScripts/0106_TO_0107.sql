-- Neues DB Feld
ALTER TABLE [OrderItem] ADD EntstehungDigitaleInhalte NVARCHAR(255) NULL;
GO

-- Neues DB Feld
ALTER TABLE [DownloadLog] ADD EntstehungDigitaleInhalte NVARCHAR(255) NULL;
GO
