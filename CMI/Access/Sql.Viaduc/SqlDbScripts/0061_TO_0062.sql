update OrderItem set signatur = CONCAT(Bestand, '#', Ablieferung, ', ', IIF(BehaeltnisNummer IS NOT NULL,
							    CONCAT('Bd. ', BehaeltnisNummer),
    						    CONCAT('Nr. ', ArchivNummer))) where signatur is null or RTRIM(signatur) = ''
