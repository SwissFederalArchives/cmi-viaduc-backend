...
namespace CMI.Web.Common.Helpers
{
    public static class Reflective
    {
        ...
        public static bool IsNullOrDefault<T>(T value)
        {
            ...
            //return ((object)default(T)) == null ? ((object)value) == null : default(T).Equals(value);
        }

        /// <summary>
        /// Get property (or field) value for type (or instance if not null) if present. Else return default of T.
        /// </summary>
        public static T GetValue<T>(Type onType, string name, object onInstance = null, BindingFlags access = (BindingFlags.Public | BindingFlags.NonPublic))
        {
        ...
        /// </summary>
        public static bool SetValue<T>(Type onType, string name, T value, object onInstance = null, BindingFlags access = (BindingFlags.Public | BindingFlags.NonPublic))
        {
            if (onInstance != null && onInstance is IDictionary)
            {
                var dictionary = onInstance as IDictionary;
        ...
        /// </summary>
        public static bool SetValueFrom<T>(object thisObject, object fromObject, string thisName, string fromName, bool useThisValue, T fromValue = default(T))
        {
        ...
        public static bool SetValueFrom<T>(object thisObject, object fromObject, string thisName, bool useThisValue, T fromValue = default(T))
        {
            return SetValueFrom(thisObject, fromObject, thisName, null, useThisValue, fromValue);
        }

        public static bool SetValueFrom<T>(object thisObject, object fromObject, string name, T fromValue = default(T))
        {
        ...
        /// </summary>
        public static Dictionary<string, T> GetProperties<T>(Type onType, object onInstance = null, BindingFlags access = (BindingFlags.Public | BindingFlags.NonPublic))
        {
            var bind = GetDefaultBindingFlags(access, onInstance);
            ...
            for (var i = 0; i < ps.Length; i++)
            {
                ...
                if (t.IsAssignableFrom(p.PropertyType))
                {
                    ...
                    if (m != null && m.GetParameters().Length <= 0)
                    {
                        T value = (onInstance == null && ((bind & BindingFlags.Instance) == BindingFlags.Instance)) ? default(T) : (T)p.GetValue(onInstance, null);
        ...
        /// </summary>
        public static Dictionary<string, T> GetFields<T>(Type onType, object onInstance = null, BindingFlags access = (BindingFlags.Public | BindingFlags.NonPublic))
        {
            var bind = GetDefaultBindingFlags(access, onInstance);
            var infos = new Dictionary<string, T>();
            ...
            for (var i = 0; i < fs.Length; i++)
            {
                ...
                {
                    T value = (onInstance == null && ((bind & BindingFlags.Instance) == BindingFlags.Instance)) ? default(T) : (T)f.GetValue(onInstance);
        ...
        public static Dictionary<string, T> GetConstants<T>(Type onType, BindingFlags access = (BindingFlags.Public | BindingFlags.Static))
        {
            ...
            var t = typeof(T);
            return onType.GetFields(bind).Where(f => f.IsLiteral && !f.IsInitOnly && f.FieldType == t).ToDictionary(f => f.Name, f => (T) f.GetRawConstantValue());
        }

        /// <summary>
        /// HasProperty
        /// </summary>
        public static bool HasProperty(Type onType, string name, out object value, object onInstance = null, BindingFlags access = (BindingFlags.Public | BindingFlags.NonPublic))
        {
            var bind = GetDefaultBindingFlags(access, onInstance);
            value = null;
            var p = onType.GetProperty(name, bind);
        ...
        /// HasField
        /// </summary>
        public static bool HasField(Type onType, string name, out object value, object onInstance = null, BindingFlags access = (BindingFlags.Public | BindingFlags.NonPublic))
        {
            var bind = GetDefaultBindingFlags(access, onInstance);
            value = null;
            var f = onType.GetField(name, bind);
        ...
        /// HasProperyOrField
        /// </summary>
        public static bool HasProperyOrField(Type onType, string name, out object value, object onInstance = null, BindingFlags access = (BindingFlags.Public | BindingFlags.NonPublic))
        {
        ...
        /// DrilldownToInstance
        /// </summary>
        public static bool DrilldownToInstance(object onObject, string path, out object instance, out string name, bool ignoreCase = false, BindingFlags access = (BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic))
        {
            instance = onObject;
            name = path;
        ...
        public static MethodInfo GetMethod(Type onType, string methodName, BindingFlags access = (BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic), Type[] types =  null)
        {
