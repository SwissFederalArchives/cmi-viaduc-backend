namespace CMI.Access.Sql.Viaduc.File
{
    public interface IDownloadLogDataAccess
    {
        ...
        void LogTokenGeneration(string token, string userId, string userTokens, string signatur, string titel, string schutzfrist, string zeitraum, string entstehungDigitaleInhalte);

        void LogViewerClick(string token, string userId, string userTokens, string signatur, string titel, string schutzfrist, string zeitraum, string entstehungDigitaleInhalte);
        /// <summary>
