...
namespace CMI.Manager.Vecteur
{
    ...
    internal static class ServerKey
    {
        ...
        {
            var content = Encoding.UTF8.GetString(Convert.FromBase64String(Properties.VecteurSettings.Default.SftpPrivateCertKey));
            var data = Encoding.ASCII.GetBytes(content);
            return new SshPrivateKey(data, Properties.VecteurSettings.Default.SftpPrivateCertPassword);
        }
    }
}