...
namespace CMI.Manager.DocumentConverter
{
    ...
    internal static class ServerKey
    {
        ...
        {
            var content = Encoding.UTF8.GetString(Convert.FromBase64String(Properties.DocumentConverterSettings.Default.SftpPrivateCertKey));
            var data = Encoding.ASCII.GetBytes(content);
            return new SshPrivateKey(data, Properties.DocumentConverterSettings.Default.SftpPrivateCertPassword);
        }
    }
}