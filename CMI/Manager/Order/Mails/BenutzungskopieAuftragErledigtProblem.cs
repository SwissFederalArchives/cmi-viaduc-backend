...
{
    public class BenutzungskopieAuftragErledigtProblem : EmailTemplate
    {
        ...
        [DefaultValue("Erstellung persönliche Gebrauchskopie nach Abschluss Digitalisierung nicht möglich " +
                      "({{Ve.Signatur}})")]
