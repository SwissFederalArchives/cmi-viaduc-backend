		...
		<html lang="de">
			...
			<body>
				...
				<script>
					...
					function openTree() {
					$('#contentTree').jstree(true).open_all();
					}

					function closeTree() {
					$('#contentTree').jstree(true).close_all();
					}
	...
	<xsl:template name="renderOrderedItem">
		...
		<div class="row form-group">
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-12">
						<a data-toggle="collapse" href="#mehrMetadaten" aria-expanded="false" aria-controls="mehrMetadaten" data-i18n="viaduc-title-mehr_weniger_metadaten">
							Mehr/weniger
							Metadaten
						</a>
					</div>
		...
		<div class="row">
			<div class="col-md-6">
				<h3 data-i18n="[html]viaduc-title-inhaltsverzeichnis">
					Inhaltsverzeichnis<br/>
					<small class="text-muted">Doppelklicken, oder Ctrl-O um Datei zu öffnen.</small>
				</h3>
				<div id="contentTree">
